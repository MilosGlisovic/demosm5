...
},
{
 ...
 {
    name: 'Procenjuje se da je Karađorđev dud star 300 godina, a upravo pod ovim stablom se davne 1805. godine odigrao važan trenutak u istoriji grada Smedereva. Baš pod ovim stablom 8. novembra 1805. godine turski zapovednik Muharem Guša je predao ključeve grada Smedereva Karađorđu, vođi Prvog srpskog ustanka. Predaja ključeva Smederevske tvrđave je izvršena u prisustvu srpskih starešina i ustanika i bila je svečana, jer su Turci Srbima ostavili topove i municiju, ponevši vojne počasti i sitno oružje lađama niz Dunav u Bugarsku.',
    h: 'Karađorđev dud',
    logo: 'logo.png',
    width: "0.5",
    height: "0.5",
 ...
 {
    name: 'Nalazi se na glavnom gradskom trgu u neposrednoj blizini hrama Sv. Georgija. Smederevo je u Prvom svetskom ratu bilo poprište jedne od najvećih bitaka i velike pobede srpske vojske na Mitrovdan 1914. godine.',
    h: 'Spomenik borcima Prvog svetskog rata',
    logo: 'logo2.png',
    width: "0.5",
    height: "0.5",
    location: {
 ...
 {
    name: 'Posvećen je narodnim herojima smederevskog kraja poginulim u Drugom svetskom ratu. Nalazi se u blizini zgrade Gradske uprave.',
    h: 'Spomen park Tri heroja',
    logo: 'logo2.png',
    width: "0.5",
    height: "0.5",
    location: {
